...
<Navbar className='Sidebar' variant='dark' collapseOnSelect expand="lg">
  ...
  <Navbar.Collapse id="responsive-navbar-nav">
    <Nav className='flex-column mt-5'>
      ...
      <Nav.Link className='SidebarItem' as={Link} to="/" disabled><Search /> Search for a case</Nav.Link>
      <Nav.Link className='SidebarItem' as={Link} to="/addcase"><BookmarkCheck /> Add and accept new cases</Nav.Link>
      <Nav.Link className='SidebarItem' as={Link} to="/" disabled><FileEarmarkFill /> Create Documents</Nav.Link>
      ...
      <Nav.Link className='SidebarItem' as={Link} to="/" disabled><Gear /> System Maintenance</Nav.Link>
      <Nav.Link className='SidebarItem' as={Link} to="/" disabled><GearFill /> Settings</Nav.Link>
